...
const Contact = () => {
  ...
  return (
    <main className="relative sm:h-screen contact " id="contact">
      <p className="bebas sm:absolute left-10 bottom-32 text-6xl text-black">
        CONTACT US
      </p>
      <section className="sm:absolute sm:top-20 sm:right-10">
        <main className="flex flex-col sm:flex-row items-center justify-center">
          <div
            className="text-sm text-[black] flex flex-col gap-2.5 px-6 py-8 bg-white
  "
          >
  ...
  "
      ...
      <div className="p-5 bg-darkest text-white w-full bottom-0 sm:absolute flex flex-col sm:flex-row sm:items-center gap-2 justify-around">
        <section>
